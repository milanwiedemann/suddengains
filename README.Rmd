...
More details can be found in the [Vignette](https://cran.r-project.org/web/packages/suddengains/vignettes/suddengains-tutorial.html) or on [PsyArXiv](https://psyarxiv.com/2wa84/).
...
```{r, fig.width = 3.5, fig.height = 3.5, dpi=200}
...
```{r, fig.width = 5, fig.height = 3.5, dpi=200}
