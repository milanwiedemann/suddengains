...
For an example see measure **bdi_s2** for **id = 2**.
...
The newly calcualted variable `sg_select` is logical and contains information whether a case is selected (`TRUE`) or not selected (`FALSE`) based on method selected.  
