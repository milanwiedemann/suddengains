...
1. The cutoff value for a clinically meaningful change on the measure to be used to identify sudden gains using can be specified using the argument `sg_crit1_cutoff`.
...
# Note: All following examples work the same for the "identify_sl()" function
# Note: The argument "crit123_details = TRUE" returns details about each between session interval for each criterion.
# Note: Details about the third criterion will show NAs for each between session interval because it's not being used (sg_crit3 = FALSE)
identify_sg(data = sgdata,
            sg_crit1_cutoff = 7,
            sg_crit2_pct = .25,
            sg_crit3 = FALSE,
...
# Note: Details about the second and third criterion will show NAs for each between session interval
identify_sg(data = sgdata,
            sg_crit1_cutoff = 7,
            sg_crit2_pct = NULL,
            sg_crit3 = FALSE,
